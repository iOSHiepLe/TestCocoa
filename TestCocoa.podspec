...
Pod::Spec.new do |spec|
  ...
  spec.subspec 'app_settings' do |s|
    s.ios.vendored_frameworks = 'app_settings.xcframework'
  end
  ...
  spec.subspec 'beacon' do |s|
    s.ios.vendored_frameworks = 'beacon.xcframework'
  end
  
  spec.subspec 'contacts_service' do |s|
    s.ios.vendored_frameworks = 'contacts_service.xcframework'
  end
  
  spec.subspec 'core' do |s|
    s.ios.vendored_frameworks = 'core.xcframework'
  end
  
  spec.subspec 'DTTJailbreakDetection' do |s|
    s.ios.vendored_frameworks = 'DTTJailbreakDetection.xcframework'
  end
  ...
  spec.subspec 'KeychainSwift' do |s|
    s.ios.vendored_frameworks = 'KeychainSwift.xcframework'
  end
  
  spec.subspec 'libPhoneNumber_iOS' do |s|
    s.ios.vendored_frameworks = 'libPhoneNumber_iOS.xcframework'
  end
